...
/*   Updated: 2025/08/30 22:56:37 by wirare           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#define _GNU_SOURCE
#include <string.h>
...
#define SYSCALL(x, name)	case x: return name;

char* __attribute__((const)) resolve_x64_syscall_num(long long syscall_number)
{
        static char* table[] = {
                [0] = "read",
                [1] = "write",
